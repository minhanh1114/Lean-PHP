...
<head>
  ...
  <meta name="twitter:title" content="<?php echo empty($title) ? "Tấm Nhựa Tân Minh Nhật: Tấm Nhựa Lấy Sáng Bền Đẹp Chất Lượng Cao" : $title ?>">
  ...
  <title><?php echo empty($title) ? "Tấm Nhựa Tân Minh Nhật: Tấm Nhựa Lấy Sáng Bền Đẹp Chất Lượng Cao" : $title ?></title>
