        ...
        <div class="col l-6 m-12 c-12">
            <div class="product-info">
                ...
                <p class="product-status">
                    <span style="font-weight: bold;">Tình trạng: </span> Còn hàng</p>
                <div class="product-submit">
                    <a href="tel:0973 022 983" class="hotline buy-product">Mua ngay</a>
                    <a href="<?php echo _WEB_ROOT . '/lien-he' ?>" class="hotline product-contact">Liên hệ</a>
                </div>
