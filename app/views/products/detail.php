...
$schema = [
    ...
    "image" => [_WEB_ROOT . '/public/assets/products/'. $dataProduct[0]['img']],
    "description" => strip_tags(htmlspecialchars_decode($dataProduct[0]['des_short'])),
    "sku" =>  $dataProduct[0]['code'],
    "brand" => [
        "@type" => "Brand",
        "name" => "Tân Minh Nhật"
    ],
    "offers" => [
        "@type" => "Offer",
        "url" => _WEB_ROOT . '/san-pham/' . $dataProduct[0]['slug'] . '.html',
        "priceCurrency" => "VND",
...
<div class="detail-product">
    <div class="row">
		...
		<div class="swiper-wrapper">
                <div class="swiper-slide slide-image_top" >
				    <img loading="lazy"  class="product-img" src="<?php  echo _WEB_ROOT . '/public/assets/products/'. $dataProduct[0]['img']?>" alt="<?php echo $dataProduct[0]['name'] ?>">
			    </div>
            <?php foreach($productImages as $productImageGallery){ ?>
                <div class="swiper-slide slide-image_top" >
				    <img loading="lazy"  class="product-img" src="<?php  echo _WEB_ROOT . '/public/assets/products/images/'.$productImageGallery['image_path']?>" alt="<?php echo $dataProduct[0]['name'] ?>">
			    </div>
	...
	<div class="swiper-container gallery-thumbs">
		<div class="swiper-wrapper">
            <?php 
                ...
                {
                    $srcImage = _WEB_ROOT . '/public/assets/products/thumb/'. $dataProduct[0]['img'];
                   echo "<div class='swiper-slide slide-image_thumb' ><img loading='lazy'  src='{$srcImage}' alt='{$dataProduct[0]['name']}' ></div>"   ;  
                }
            foreach($productImages as $productImageGallery){ ?>
                <div class="swiper-slide slide-image_thumb" >
				    <img loading="lazy"   src="<?php  echo _WEB_ROOT . '/public/assets/products/images/thumb_images/'.$productImageGallery['image_path']?>" alt="<?php echo $dataProduct[0]['name'] ?>">
			    </div>
        ...
        <div class="col l-6 m-12 c-12">
            <div class="product-info">
                <h1 class="product-title" data-available="Còn hàng"><?php echo $dataProduct[0]['name'] ?></h1>
                <p class="product-code">
                    <span style="font-weight: bold;">Mã sản phẩm: </span>
                     <?php echo  $dataProduct[0]['code'] ?>
                </p>
                <div class="product_price-wrap">
                    <span class ="product_price"><?php echo $dataProduct[0]['price']>0 ?  number_format($dataProduct[0]['price'],0,',',',').'₫' :  "Liên hệ" ; ?>
                    </span>
                    <del class ="product_price-compare"><?php echo $dataProduct[0]['price']>0&&$dataProduct[0]['discount_percentage']>0 ? calculatorPrice($dataProduct[0]['price'],$dataProduct[0]['discount_percentage']):"" ?></del>
                    <span class="product_discount-percent"><?php echo $dataProduct[0]['discount_percentage']>0 ?  '-'.$dataProduct[0]['discount_percentage'] .'%' : "" ?><span>
                </div>
                <div class="product-des">
                    <?php echo htmlspecialchars_decode($dataProduct[0]['des_short']) ?>
                </div>
                <div class="product-submit">
                    <a href="tel:0964 297 683" class="hotline buy-product">
                        <span>MUA NGAY</span>
                        <small>(Giao tận nơi hoặc lấy tại cửa hàng)</small>
                    </a>
                    <a href="<?php echo _WEB_ROOT . '/lien-he' ?>" class="hotline product-contact">
                            <span>LIÊN HỆ</span>
                ...
                <div class="product-attention">
                    <p>
                        ...
                        <span><a style="color:#2C74B3" href="https://zalo.me/0961045066">0961 045 066</a> hoặc <a style="color:#2C74B3" href="tel:0973 022 983">0973 022 983</a></span>
                    </p>
                </div>
...
<div class="product-describe_container">
    ...
    <div class="row">
        <div class="col l-12 m-12 c-12">
            ...
            <div  class="show-star_rate show_product_pane">
...
<script>
    ...
    const showProductPanes = document.querySelectorAll('.show_product_pane');

    headingDesProduct.forEach((item,index) => {
            const showProductPane = showProductPanes[index];
            item.addEventListener('click', (e) => {
            
            document.querySelector('.show-product-heading.active-des_product').classList.remove('active-des_product');
            document.querySelector('.show_product_pane.active-tab_content').classList.remove('active-tab_content');
            item.classList.add('active-des_product');
            showProductPane.classList.add('active-tab_content');
            });
